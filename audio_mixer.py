...
def mix_audio_into_video(
    ...
    Args:
        ...
        event_timeline: [{"type": "goal"|"whistle_start"|"whistle_end", "time": float}, ...]
    ...
    # Arka plan müziği (trim to video length + smooth fade in/out)
    ...
    filter_parts.append(
        f"{mix_input}amix=inputs={n_streams}:duration=first:dropout_transition=2:normalize=0[aout]"
    )
