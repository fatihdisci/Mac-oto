...
POP_CULTURE_CATEGORIES: list[dict] = [
    ...
    },
    {
        "id": "music_bands",
        "name": "Muzik Gruplari",
        "display_title": "BAND WARS",
        "theme_primary": (222, 78, 128),
        "theme_secondary": (78, 170, 242),
        "background_color": (20, 12, 30),
        "contestants": [
            {"name": "Metallica", "short_name": "MTLC", "color": (45, 45, 45), "universe": "Music"},
            {"name": "Linkin Park", "short_name": "LINK", "color": (205, 52, 52), "universe": "Music"},
            {"name": "Nirvana", "short_name": "NIRV", "color": (240, 205, 55), "universe": "Music"},
            {"name": "Queen", "short_name": "QN", "color": (190, 150, 65), "universe": "Music"},
            {"name": "Coldplay", "short_name": "COLD", "color": (55, 115, 235), "universe": "Music"},
            {"name": "BTS", "short_name": "BTS", "color": (132, 86, 220), "universe": "Music"},
            {"name": "Imagine Dragons", "short_name": "DRGN", "color": (228, 108, 50), "universe": "Music"},
            {"name": "Pink Floyd", "short_name": "PFLD", "color": (245, 118, 195), "universe": "Music"},
        ],
    },
    {
        "id": "movies",
        "name": "Filmler",
        "display_title": "CINEMA WARS",
        "theme_primary": (255, 199, 66),
        "theme_secondary": (82, 142, 255),
        "background_color": (14, 14, 20),
        "contestants": [
            {"name": "The Godfather", "short_name": "GODF", "color": (62, 62, 62), "universe": "Movie"},
            {"name": "Titanic", "short_name": "TITN", "color": (88, 170, 242), "universe": "Movie"},
            {"name": "Inception", "short_name": "INCP", "color": (88, 128, 222), "universe": "Movie"},
            {"name": "Interstellar", "short_name": "INTS", "color": (98, 148, 255), "universe": "Movie"},
            {"name": "The Dark Knight", "short_name": "TDK", "color": (42, 42, 52), "universe": "Movie"},
            {"name": "Avatar", "short_name": "AVTR", "color": (62, 176, 255), "universe": "Movie"},
            {"name": "The Matrix", "short_name": "MTRX", "color": (52, 188, 112), "universe": "Movie"},
            {"name": "Gladiator", "short_name": "GLAD", "color": (218, 156, 74), "universe": "Movie"},
        ],
    },
    {
        "id": "fashion_brands",
        "name": "Giyim Markalari",
        "display_title": "FASHION BRAND WARS",
        "theme_primary": (248, 248, 248),
        "theme_secondary": (120, 128, 142),
        "background_color": (24, 24, 28),
        "contestants": [
            {"name": "Nike", "short_name": "NIKE", "color": (245, 245, 245), "universe": "Fashion"},
            {"name": "Adidas", "short_name": "ADID", "color": (225, 225, 225), "universe": "Fashion"},
            {"name": "Puma", "short_name": "PUMA", "color": (245, 245, 245), "universe": "Fashion"},
            {"name": "Zara", "short_name": "ZARA", "color": (225, 225, 225), "universe": "Fashion"},
            {"name": "HM", "short_name": "HM", "color": (230, 230, 230), "universe": "Fashion"},
            {"name": "Gucci", "short_name": "GCCI", "color": (68, 124, 72), "universe": "Fashion"},
            {"name": "Louis Vuitton", "short_name": "LV", "color": (186, 142, 84), "universe": "Fashion"},
            {"name": "Prada", "short_name": "PRDA", "color": (240, 240, 240), "universe": "Fashion"},
        ],
    },
    {
        "id": "coffee_brands",
        "name": "Kahve Markalari",
        "display_title": "COFFEE BRAND WARS",
        "theme_primary": (130, 78, 44),
        "theme_secondary": (226, 178, 118),
        "background_color": (26, 14, 8),
        "contestants": [
            {"name": "Starbucks", "short_name": "STRB", "color": (0, 112, 74), "universe": "Coffee"},
            {"name": "Nespresso", "short_name": "NESP", "color": (206, 206, 206), "universe": "Coffee"},
            {"name": "Lavazza", "short_name": "LAVA", "color": (24, 68, 148), "universe": "Coffee"},
            {"name": "Illy", "short_name": "ILLY", "color": (212, 46, 46), "universe": "Coffee"},
            {"name": "Costa Coffee", "short_name": "COST", "color": (140, 20, 46), "universe": "Coffee"},
            {"name": "Dunkin", "short_name": "DNKN", "color": (255, 105, 0), "universe": "Coffee"},
            {"name": "Tim Hortons", "short_name": "TIMH", "color": (186, 26, 26), "universe": "Coffee"},
            {"name": "Peets Coffee", "short_name": "PEET", "color": (118, 92, 56), "universe": "Coffee"},
        ],
    },
    {
        "id": "car_brands",
        "name": "Araba Markalari",
        "display_title": "AUTO BRAND WARS",
        "theme_primary": (220, 52, 52),
        "theme_secondary": (126, 146, 172),
        "background_color": (12, 16, 22),
        "contestants": [
            {"name": "Ferrari", "short_name": "FER", "color": (208, 36, 36), "universe": "Automotive"},
            {"name": "Lamborghini", "short_name": "LAMB", "color": (224, 180, 44), "universe": "Automotive"},
            {"name": "Porsche", "short_name": "PORS", "color": (182, 52, 52), "universe": "Automotive"},
            {"name": "BMW", "short_name": "BMW", "color": (58, 138, 238), "universe": "Automotive"},
            {"name": "Mercedes Benz", "short_name": "MB", "color": (186, 194, 210), "universe": "Automotive"},
            {"name": "Audi", "short_name": "AUDI", "color": (208, 208, 208), "universe": "Automotive"},
            {"name": "Toyota", "short_name": "TYTA", "color": (206, 34, 34), "universe": "Automotive"},
            {"name": "Tesla", "short_name": "TSLA", "color": (210, 26, 26), "universe": "Automotive"},
        ],
    },
]
